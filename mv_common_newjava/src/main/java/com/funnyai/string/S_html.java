...
public class S_html {
    ...
    public static void main(String [] args){
            System.out.println(html2text("<ul>产品特点"));
    }

    public static String[][] HTML_TO_Array(String html){
        ...
        for (Element table : tables) {
            ...
            for (Element tr : trs) {
                ...
                if (tds.size()>Max_Cols) Max_Cols=tds.size();
                Max_Rows+=1;
            }
        }

        pTable=new String[Max_Rows][Max_Cols];
        int i,j=0;
        for (Element table : tables) {
            Elements trs = table.getElementsByTag("tr");
            for (Element tr : trs) {
    ...
    public static String html2text(Object... a) {
        String html=(String) a[0];
