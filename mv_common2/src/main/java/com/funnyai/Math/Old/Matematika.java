...
final public class Matematika
   ...
   public static double varr( long n, long r )
	...
	public static double max( Vector tokeni, int pozicija_funkcije )
   	{
		int		i;
		double	broj;
		double	maksimum;
	...
	public static double min( Vector tokeni, int pozicija_funkcije )
   	{
		int		i;
		double	broj;
		double	minimum;
	...
	public static double sum( Vector tokeni, int pozicija_funkcije )
   	{
		int		i;
		double	broj;
		double	suma=0;
	...
	public static double avg( Vector tokeni, int pozicija_funkcije )
   	{
		int		i;
      int      n=0;
		double	broj;
	...
	public static double count( Vector tokeni, int pozicija_funkcije )
   	{
		int		i;
      int      n=0;
		Token		t;
	...
	public static double stddev( Vector tokeni, int pozicija_funkcije )
   	{
		int		i;
      int      n=0;
		double	broj;
