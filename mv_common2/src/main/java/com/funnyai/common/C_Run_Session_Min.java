 ...
 * @author happyli
 */
public class C_Run_Session_Min {
    ...
    public C_Run_Session_Min(int ID,int priority){
    ...
    public static C_Run_Session_Min Get_New_Session_From_ID(int ID,int priority){
        
        C_Run_Session_Min pRun_Session;
        
        if (AI_Var2.pRun_Sessions.containsKey(ID)){
            pRun_Session=new C_Run_Session_Min(ID,priority);
            AI_Var2.pRun_Sessions.put(pRun_Session.ID,pRun_Session);
        }else{
            pRun_Session=(C_Run_Session_Min) AI_Var2.pRun_Sessions.get(ID);
        }
        return pRun_Session;
    }
    
    public static C_Run_Session_Min Get_New_Session(int ID,int priority){
        C_Run_Session_Min pRun_Session;
        pRun_Session=new C_Run_Session_Min(0,priority);
